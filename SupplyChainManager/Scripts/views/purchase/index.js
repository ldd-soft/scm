...
var buildGrid = function () {
            ...
            listeners: {
                'select': function (combo, record, index) {
                    ...
                    if (index == 1) {
                        ...
                        grid.getStore().reload();
                        //Ext.fly('list_title').update('采购列表 : ');
                    }
                }
            }
        })
    ...
    var columns_item = [
                ...
                { header: '商品数量', width: 70, dataIndex: 'Quantity' },
                { header: '价格', width: 80, dataIndex: 'Price', renderer: renderFloat },
                { header: '优惠价', width: 80, dataIndex: 'Promotion', renderer: renderFloat },
