...
Ext.calendar.MonthView = Ext.extend(Ext.calendar.CalendarView, {
    ...
    */
    ...
    singleClickTask: new Ext.util.DelayedTask(this.singleClickAction),  // our delayed task for single click
    singleClickDelay: 100, // delay in milliseconds
    singleClickAction: function (dt) {
        console.log('ok2');
    ...
    onDblClick: function (e, t) {
        ...
        if (Ext.calendar.MonthView.superclass.onDblClick.apply(this, arguments)) {
            // The superclass handled the click already so exit
            return;
        }
        if (this.dropZone) {
        ...
        if (el) {
            if (el.id && el.id.indexOf(this.dayElIdDelimiter) > -1) {
               ...
               // this.singleClickTask.cancel();
                ...
                this.fireEvent('daydblclick', this, Date.parseDate(dt, 'Ymd'), false, Ext.get(this.getDayId(dt)));
                return;
            }
        }
    ...
    initEventRelay: function(cfg) {
        ...
        cfg.listeners.afterrender = {
            fn: function(c) {
                ...
                this.relayEvents(c, ['eventsrendered', 'eventclick', 'eventover', 'eventout', 'dayclick', 'daydblclick',
